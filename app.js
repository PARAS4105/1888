app = angular.module("1888", ['ngRoute', /*'ngIdle',*/ 'base64', 'ngStorage', 'ngValidate', 'ngSanitize', 'ngFileUpload', /*'checklist-model',*/ "ui.bootstrap", /*"angular-google-analytics",*/ 'ksSwiper', /*'hl.sticky',*/ 'ui.swiper', 'ngMaterial' /*'ngMessages',*/ /*'socialbase.sweetAlert',*/ /*'rzModule',*/ /*'socialLogin',*/ /*'angular-nicescroll',*/ /*'ui.bootstrap.datetimepicker',*/ /*'angular-progress-arc'*/]);
/*ngImgCrop*/

app.$inject = ['SweetAlert'];

var base_url = 'http://192.168.50.15/1888/';
var apiUrl = "http://192.168.50.15/1888/api/admin/";

// var base_url = 'https://www.1888ev.com/';
// var apiUrl = 'https://www.1888ev.com/api/admin';
...
app.config(['$locationProvider', '$routeProvider', '$validatorProvider', /*'AnalyticsProvider',*/ /*'socialProvider',*/
	function ($locationProvider, $routeProvider, $validatorProvider /*AnalyticsProvider,*/ /*socialProvider*/) {
		...
		$routeProvider.when("/contact", {
			templateUrl: "templates/forms/contactForm.html?ver=12-01-2023-v1",
...
app.controller("MainController", function ($scope, $location, $rootScope, $timeout, $http, $localStorage, $routeParams, $window, $route, $base64, $timeout, $sce, $mdToast, $filter, $interval) {
	...
	// $scope.activePath = window.location.href;
	...
	$scope.inquiry_obj = {};
	$scope.inquiry_obj.type = "General Inquiry";
	$scope.addContactUs = false;
	$scope.contactUsSavetext = "Submit";
	$scope.submit_inquiry = function (form) {
	...
	$scope.openInquiry = function () {
		if ($scope.contactForm == false) {
	...
	$scope.mobile_menu_click = function () {
		if ($scope.isMobileMenuOpen == false) {
	...
	$scope.mobile_menu_click_close = function () {
		$scope.isMobileMenuOpen = false;
	}
